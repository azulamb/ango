/// <reference path="./morse-preview.ts" />

interface MorseCodeNode extends MorseNode {
	parent?: MorseCodeNode;
	dot?: MorseCodeNode;
	dash?: MorseCodeNode;
	value: string;
	route: SVGPathElement;
	frame: SVGPathElement | SVGCircleElement;
}
	...
	customElements.define(
		...
		class MorseCode extends HTMLElement {
			...
			constructor() {
				...
				this.preview = new (<{ new (): MorsePreview }> customElements.get('morse-preview'))();
			...
			protected addChar(char: string) {
				this.text.value += char;
				this.changeFromText();
				this.updateMorse();
			}

			protected updateMorse() {
			...
			protected createTree(codes: { [keys: string]: MorseCodeNode }) {
				function connect(parent: string | MorseCodeNode, dot: string, dash: string) {
			...
			protected createSVG() {
				...
				[
					...
					},
					{
						...
						cy: 36,
						char:
							'm59 33.5a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h1.3594l-0.84375 3.3789a0.5 0.5 0 0 0 0.36328 0.60547 0.5 0.5 0 0 0 0.60547-0.36328l1-4a0.50005 0.50005 0 0 0-0.48438-0.62109z',
					},
					{
						key: '8',
						route: 'm51 52 9-8',
					...
					},
					{
						...
						cy: 20,
						char:
							'm12 17.5c-0.27613 2.8e-5 -0.49997 0.22387-0.5 0.5v4c0 0.27614 0.22386 0.5 0.5 0.5s0.5-0.22386 0.5-0.5v-1.5h1c0.27614 0 0.5-0.22386 0.5-0.5s-0.22386-0.5-0.5-0.5h-1v-1h1.5c0.27614 0 0.5-0.22386 0.5-0.5s-0.22386-0.5-0.5-0.5z',
					},
					{
						key: 'g',
						route: 'm39 48 5-8',
					...
					},
					{
						...
						cy: 4,
						char:
							'm12 1.5c-0.27614 0-0.5 0.22386-0.5 0.5v4c0 0.27614 0.22386 0.5 0.5 0.5s0.5-0.22386 0.5-0.5v-1.5h1v1.5c0 0.27614 0.22386 0.5 0.5 0.5s0.5-0.22386 0.5-0.5v-4c0-0.27614-0.22386-0.5-0.5-0.5s-0.5 0.22386-0.5 0.5v1.5h-1v-1.5c0-0.27614-0.22386-0.5-0.5-0.5z',
					},
					{
						key: 'i',
						route: 'm25 32v-16',
						...
						cy: 16,
						char:
							'm24 13.5a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h0.5v3h-0.5a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h2a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-0.5v-3h0.5a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5z',
					},
					{
						key: 'l',
						route: 'm20 40-7-4',
						...
						cy: 36,
						char:
							'm12 33.5a0.5 0.5 0 0 0-0.5 0.5v4a0.50005 0.50005 0 0 0 0.5 0.5h2a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-1.5v-3.5a0.5 0.5 0 0 0-0.5-0.5z',
					},
					{
						key: 'n',
						route: 'm39 32v-16',
						...
						cy: 16,
						char:
							'm40 13.5a0.5 0.5 0 0 0-0.5 0.5v1.8828l-1.0527-2.1055a0.50005 0.50005 0 0 0-0.94727 0.22266v4a0.5 0.5 0 0 0 0.5 0.5 0.5 0.5 0 0 0 0.5-0.5v-1.8828l1.0527 2.1055a0.50005 0.50005 0 0 0 0.94727-0.22266v-4a0.5 0.5 0 0 0-0.5-0.5z',
					},
					{
						key: 'p',
						route: 'm20 56-7-4',
					...
					},
					{
						...
						cy: 36,
						char:
							'm50 33.5a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h1.1914l-1.6387 3.2773a0.50005 0.50005 0 0 0 0.44727 0.72266h2a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-1.1914l1.6387-3.2773a0.50005 0.50005 0 0 0-0.44727-0.72266z',
					},
				...
				[
					...
					},
					{
						...
						char:
							'm4.1914 57.539a0.50005 0.50005 0 0 0-0.54492 0.10742l-1 1a0.5 0.5 0 0 0 0 0.70703 0.5 0.5 0 0 0 0.70703 0l0.14648-0.14648v2.793a0.5 0.5 0 0 0 0.5 0.5 0.5 0.5 0 0 0 0.5-0.5v-4a0.50005 0.50005 0 0 0-0.30859-0.46094z',
					},
					{
						key: '2',
						route: 'm13 28h-9',
					...
					},
					{
						...
						char:
							'm25 45.475c-0.75 0-1.5 0.65278-1.5 1.625v2.9004a0.5 0.5 0 0 0 0.5 0.5 0.5 0.5 0 0 0 0.5-0.5v-0.5h1v0.5a0.5 0.5 0 0 0 0.5 0.5 0.5 0.5 0 0 0 0.5-0.5v-2.9004c0-0.97222-0.75-1.625-1.5-1.625zm0 1c0.25 0 0.5 0.09722 0.5 0.625v1.4004h-1v-1.4004c0-0.52778 0.25-0.625 0.5-0.625z',
					},
					{
						key: 'j',
						route: 'm20 56-7 4',
					...
					},
					{
						...
						char:
							'm38 29.5c-0.27614 0-0.5 0.22386-0.5 0.5s0.22386 0.5 0.5 0.5h0.5v3.5c0 0.27614 0.22386 0.5 0.5 0.5s0.5-0.22386 0.5-0.5v-3.5h0.5c0.27614 0 0.5-0.22386 0.5-0.5s-0.22386-0.5-0.5-0.5z',
					},
					{
						key: 'u',
						route: 'm25 16-5 8',
					...
					},
					{
						...
						char:
							'm11.879 9.5156a0.5 0.5 0 0 0-0.36328 0.60547l1 4a0.50005 0.50005 0 0 0 0.96875 0l1-4a0.5 0.5 0 0 0-0.36328-0.60547 0.5 0.5 0 0 0-0.60547 0.36328l-0.51562 2.0625-0.51562-2.0625a0.5 0.5 0 0 0-0.60547-0.36328z',
					},
					{
						key: 'w',
						route: 'm25 48-5 8',
